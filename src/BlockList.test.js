...
test('BlockList.create', assert => {
  ...
  assert.equal(
    BlockList.getFirst(BlockList.create([block])),
    block,
...
test('BlockList.isEmpty', assert => {
  ...
  assert.equal(
    BlockList.isEmpty(BlockList.create()),
    true,
...
test('BlockList.removeSelection', assert => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      {
        text:
          ' consectetur adipiscursus sem quis placerat.',
        spans: [
          {
            start: 0,
            end: 13,
...
test('BlockList.copySelection', assert => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      {
        text:
          'Aliquam accumsan cursus sem quis placera',
        spans: [
          { start: 0, end: 30, formats: {} },
          {
            start: 30,
...
test('BlockList.removeCharBeforeSelection', assert => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      {
        text:
          ' consectetur adipiscing elit.Aliquam accumsan cursus sem quis placerat.',
        spans: [
          {
            start: 0,
            end: 13,
