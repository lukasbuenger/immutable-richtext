...
test('EditorState.getSelection', (assert) => {
    ...
    const editorState = EditorState.create(selection, fixtures);

    assert.equal(
        EditorState.getSelection(editorState) === selection,
        true,
    );
});
...
test('EditorState.getBlockList', (assert) => {
    ...
    assert.equal(
        EditorState.getBlockList(editorState) === fixtures,
        true,
    );
});
...
test('EditorState.removeSelection', (assert) => {
    ...
    assert.deepEqual(
        EditorState.removeSelection(
            EditorState.create(
                Selection.create({ startIndex: 0, endIndex: 1, startOffset: 6, endOffset: 17 }),
                fixtures,
            ),
        ).toJS(),
        {
...
test('EditorState.insertOrSplitBlockAfterSelection', (assert) => {
    ...
    assert.deepEqual(
        EditorState.insertOrSplitBlockAfterSelection(
            EditorState.create(
                Selection.create({ startIndex: 0, endIndex: 0, startOffset: 27, endOffset: 27 }),
                fixtures,
            ),
        ).toJS(),
        {
...
test('EditorState.insertTextAfterSelection', (assert) => {
            ...
            blocks: [
                {
                    ...
                    spans: [
                        { start: 0, end: 12, formats: {} },
                        { start: 12, end: 30, formats: { i: { name: 'i', data: {} } } },
                    ],
                },
                {
                    text: ' consectetur adipiscing elit.',
    ...
    assert.deepEqual(
        EditorState.insertTextAfterSelection(
            'FOO',
            EditorState.create(
                Selection.create({ startIndex: 1, endIndex: 1, startOffset: 13, endOffset: 13 }),
                fixtures,
            ),
        ).toJS(),
        {
...
test('EditorState.removeCharBeforeSelection', (assert) => {
    ...
    assert.deepEqual(
        EditorState.removeCharBeforeSelection(
            EditorState.create(
                Selection.create({ startIndex: 0, endIndex: 0, startOffset: 12, endOffset: 12 }),
                fixtures,
            ),
        ).toJS(),
        {
            ...
            blocks: [
                {
                    ...
                    spans: [
                        ...
                        { start: 11, end: 26, formats: { i: { name: 'i', data: {} } } },
                    ],
                },
                {
                    text: ' consectetur adipiscing elit.',
    ...
    assert.deepEqual(
        EditorState.removeCharBeforeSelection(
            EditorState.create(
                Selection.create({ startIndex: 1, endIndex: 1, startOffset: 0, endOffset: 0 }),
                fixtures,
            ),
        ).toJS(),
        {
            ...
            blocks: [
                {
                    ...
                    spans: [
                        { start: 0, end: 12, formats: {} },
                        { start: 12, end: 40, formats: { i: { name: 'i', data: {} } } },
    ...
    assert.equal(
        EditorState.getBlockList(
            EditorState.removeCharBeforeSelection(
                EditorState.create(
                    Selection.create({ startIndex: 0, endIndex: 0, startOffset: 0, endOffset: 0 }),
                    fixtures,
                ),
            ),
        ),
            ...
            blocks: [
                {
                    ...
                    spans: [
                        { start: 0, end: 12, formats: {} },
                        { start: 12, end: 26, formats: { i: { name: 'i', data: {} } } },
                    ],
                },
                {
                    text: ' consectetur adipiscing elit.',
...
test('EditorState.copySelection', (assert) => {
    ...
    assert.deepEqual(
        EditorState.copySelection(
            EditorState.create(
                Selection.create({ startIndex: 1, endIndex: 2, startOffset: 13, endOffset: 32 }),
                fixtures,
            ),
        ).toJS(),
        {
            ...
            blocks: [
                ...
                {
                    text: 'Aliquam accumsan cursus sem quis',
                    spans: [
                        { start: 0, end: 30, formats: {} },
                        { start: 30, end: 32, formats: { i: { name: 'i', data: {} } } },
                    ],
                },
            ],
        },
    ...
    assert.deepEqual(
        ...
        ).toJS(),
        {
            ...
            blocks: [
                ...
                {
                    text: 'Aliquam accumsan cursus sem quisLorem ipsum dolor sit amet,',
                    spans: [
                        { start: 0, end: 30, formats: {} },
                        { start: 30, end: 32, formats: { i: { name: 'i', data: {} } } },
                        { start: 32, end: 44, formats: {} },
                        { start: 44, end: 59, formats: { i: { name: 'i', data: {} } } },
                    ],
                },
                {
                    text: ' consectetur adipiscing elit.',
    ...
    assert.deepEqual(
        ...
        ).toJS(),
        {
            ...
            blocks: [
                ...
                {
                    text: ' consectetur adipadipiscing elit.',
                    spans: [
                        { start: 0, end: 13, formats: { i: { name: 'i', data: {} } } },
                ...
                {
                    text: 'Aliquam accumsan cursus sem quisiscing elit.',
                    spans: [
                        { start: 0, end: 30, formats: {} },
                        { start: 30, end: 32, formats: { i: { name: 'i', data: {} } } },
                        { start: 32, end: 44, formats: {} },
            ...
            blocks: [
                {
                    ...
                    spans: [
                        { start: 0, end: 12, formats: {} },
                        { start: 12, end: 15, formats: { i: { name: 'i', data: {} } } },
                        { start: 15, end: 27, formats: { i: { name: 'i', data: {} }, b: { name: 'b', data: {} } } },
                    ],
                },
                {
                    text: ' consectetur adipiscing elit.',
                    spans: [
                        { start: 0, end: 6, formats: { i: { name: 'i', data: {} }, b: { name: 'b', data: {} } } },
                        { start: 6, end: 13, formats: { i: { name: 'i', data: {} } } },
                        { start: 13, end: 29, formats: {} },
                    ],
                },
                {
